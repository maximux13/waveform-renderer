...
describe('WaveformRenderer', () => {
  ...
  describe('Debug API', () => {
    ...
    it('should return debug info', () => {
      const mockDebugInfo = {
        performance: { lastRenderTime: 10, averageRenderTime: 15, totalRenders: 5, fps: 60, cacheBuilds: 2, lastCacheBuildTime: 5 },
        state: { canvasSize: { width: 800, height: 200 }, peaksCount: 10, barsRendered: 100, cacheValid: true, dirtyFlags: { peaks: false, options: false, size: false, progress: false } },
