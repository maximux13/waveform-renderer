...
describe("EventHandlerManager", () => {
    ...
    describe("click handling", () => {
        ...
        it("should handle click events and calculate progress", () => {
            ...
            const clickHandler = (mockCanvas.addEventListener as any).mock.calls
    ...
    describe("touch handling", () => {
        ...
        it("should handle touch events and calculate progress", () => {
            ...
            const touchHandler = (mockCanvas.addEventListener as any).mock.calls
    ...
    describe("edge cases", () => {
        ...
        it("should handle canvas without getBoundingClientRect", () => {
            ...
            const clickHandler = (brokenCanvas.addEventListener as any).mock.calls
                .find((call: any) => call[0] === "click")[1];
